...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__characters_json__ = __webpack_require__(339);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__index_less__ = __webpack_require__(337);
...
kill = kill.data(characterLinked(map, 'killed')).enter().append("path").each(function (d) {
  d.source = d[0];
  d.target = d[d.length - 1];
  __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).attr("d", line(d.linknum));
}).attr("class", "link kill");

wed = wed.data(characterLinked(map, 'wed')).enter().append("path").each(function (d) {
  d.source = d[0];
  d.target = d[d.length - 1];
  __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).attr("d", line(d.linknum));
}).attr("class", "link wed");

parented = parented.data(characterLinked(map, 'parented')).enter().append("path").each(function (d) {
  d.source = d[0];
  d.target = d[d.length - 1];
  __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).attr("d", line(d.linknum));
...
function characterLinked(map, linkType) {
